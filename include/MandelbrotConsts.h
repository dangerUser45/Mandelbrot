...
const FLOAT_TYPE Y_CENTRE_START_POS     = 0.0;

const FLOAT_TYPE START_PIXEL_SIZE       = 0.004;

const FLOAT_TYPE ONE_BILLION            = 1000000000.0;
const FLOAT_TYPE ONE_MILLION            = 1000000.0;
const FLOAT_TYPE ONE_THOUSAND           = 1000.0;
